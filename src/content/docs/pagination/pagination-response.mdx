...
<CodeBlock title="Example of an offset-based pagination metadata:">
    ```json
    {
    "meta": {
        "total": 100,
...
<CodeBlock title="Example of paginated data:">
...
<CodeBlock title="Example of links information in a paginated response:">
...
<CodeBlock title="Combining all the elements, a complete paginated response might look like this:">
```json
{
  "meta": {
    "total": 100,

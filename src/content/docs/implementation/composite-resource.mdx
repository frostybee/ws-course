...
5. **Unified Response**:
  ...
  <CodeBlock title="JSON representation example of a composite resource:">
...
<CodeBlock title="Example of a composite resource implementation using Slim Framework:">
   ```php
    /**
